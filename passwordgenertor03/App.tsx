...
const passwordShema = Yup.object().shape({
  ...
  .min(4,'Should be Min of 4 charaters')
...
export default function App() {
  ...
  const generatePasswordString = (passwordLength : number) => {
    ...
    const lowerCaseChar = 'abcdefghijklmnopqstruvwxyz';
    const upperCaseChar = 'ABCDEFGHIJKLMNOPQSTRUVWXYZ';
  ...
  const createPassword = (characters : string,passwordLength : number) => {
    ...
    //making a string password first
  ...
  return (
   <ScrollView keyboardShouldPersistTaps="handled">
      ...
      onSubmit={(values) => {
        ...
        generatePasswordString(+values.passwordLength ) //check string -> number
      }}
     >
       {({
         values,
